...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function fetchSectores() {
        try {
            const res = await fetch("https://backend-algeciras.hawkins.es:8446/api/sectores/");
    ...
    async function fetchLibresPorSector(sectorId) {
        try {
            const res = await fetch(`https://backend-algeciras.hawkins.es:8446/api/asientos/sector/${sectorId}`);
            const data = await res.json();
    ...
    async function fetchAsientos(sectorId) {
        const res = await fetch(`https://backend-algeciras.hawkins.es:8446/api/asientos/sector/${sectorId}?partidoId=proximos`);
        const data = await res.json();
        ...
        continuar.addEventListener("click", () => {
            ...
            form.addEventListener("submit", async (e) => {
                ...
                for (let i = 0; i < asientosSeleccionados.length; i++) {
                    ...
                    try {
                        const res = await fetch("https://backend-algeciras.hawkins.es:8446/api/abonos/create", {
                            method: "POST",
